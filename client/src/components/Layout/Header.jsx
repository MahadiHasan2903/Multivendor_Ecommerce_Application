  ...
  return (
    <>
      ...
      <div
        ...
        } transition hidden  800px:flex items-center justify-between w-full bg-[#0A1929] h-[70px]`}
      >
        <div
              ...
              <div className={`${styles.noramlFlex}`}>
                <div className="relative cursor-pointer mr-[15px]">
                  <Link to="/partner-profile">
                    <GiMagicPortal size={30} color="rgb(255 255 255 /83%)" />
                  </Link>
                </div>
              </div>
          ...
          <div>
            <Link to="/">
              <img
                ...
                alt=""
                style={{ width: "15%" }}
                className="mt-3 cursor-pointer ml-[120px]"
              />
            </Link>
          </div>
          <div>
            ...
            <div className="fixed w-[70%] bg-[#fff] h-screen top-0 left-0 z-10 overflow-y-scroll">
              ...
              <div className={`${styles.noramlFlex}`}>
                <div className="relative ml-5 cursor-pointer">
                  <Link to="/partner-profile">
                    <GiMagicPortal size={30} color="crimson" />
                  </Link>
                </div>
              </div>
              ...
              <div className="flex w-full ml-5">
                {isAuthenticated ? (
                  ...
                  <>
                    <Link
                      to="/login"
                      className="text-[18px] pr-[10px] text-[#0eae88] flex items-center"
                    >
                      Login <MdOutlineLogin size={25} className="ml-2" />
                    </Link>
                  </>
                )}
              </div>
